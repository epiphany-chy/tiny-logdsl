 ...
 */
package logdsl.antlr4.engine.mvel2.optimizers.impl.asm;
...
public class ASMAccessorOptimizer extends AbstractOptimizer implements AccessorOptimizer {
    ...
    static {
        ...
        String defaultNameSapce = getProperty("logdsl.antlr4.engine.mvel2.namespace");
        ...
        String jitListImpl = getProperty("logdsl.antlr4.engine.mvel2.jit.list_impl");
        if (jitListImpl == null) {
    ...
    private void _initJIT() {
        ...
        m.visitMethodInsn(INVOKESPECIAL, "java/lang/Object",
                "<init>", "()V", INVOKESPECIAL == Opcodes.INVOKEINTERFACE);
        m.visitInsn(RETURN);
                ...
                if (ctx instanceof Map) {
                    if (MVEL.COMPILER_OPT_ALLOW_OVERRIDE_ALL_PROPHANDLING && hasPropertyHandler(Map.class)) {
                        ...
                        mv.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "put",
                                "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", INVOKESPECIAL == Opcodes.INVOKEINTERFACE);
                    ...
                    if (MVEL.COMPILER_OPT_ALLOW_OVERRIDE_ALL_PROPHANDLING && hasPropertyHandler(List.class)) {
                        ...
                        mv.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "set", "(ILjava/lang/Object;)Ljava/lang/Object;", INVOKESPECIAL == Opcodes.INVOKEINTERFACE);
