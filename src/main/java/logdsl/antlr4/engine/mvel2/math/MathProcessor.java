        ...
        switch (operation) {
            case ADD:
                if (type1 == DataTypes.COLLECTION) {
                    ...
                    return MapProcessor.append((Map)val1, (Map)val2);
                }
                else {
            ...
            case SUB:
                if (type1 == DataTypes.COLLECTION) {
                    List list = new ArrayList((Collection) val1);
                    list.removeAll((Collection) val2);
                    return list;
                } else if (val1 instanceof Map) {
                    return MapProcessor.exclude((Map)val1, (Collection) val2);
                }
            case DIV:
            case MULT:
            case MOD:
            ...
            case DataTypes.W_INTEGER:
                switch (operation) {
                    ...
                    case POWER:
                        ...
                        return d > Integer.MAX_VALUE ? d : (int) d;
                    case MOD:
                        return ((Integer) val1) % ((Integer) val2);
                    case GTHAN:
            ...
            case DataTypes.W_SHORT:
                switch (operation) {
                    ...
                    case POWER:
                        ...
                        return d > Short.MAX_VALUE ? d : (short) d;
                    case MOD:
                        return ((Short) val1) % ((Short) val2);
                    case GTHAN:
            ...
            case DataTypes.W_LONG:
                switch (operation) {
                    ...
                    case POWER:
                        ...
                        return d > Long.MAX_VALUE ? d : (long) d;
                    case MOD:
                        return ((Long) val1) % ((Long) val2);
                    case GTHAN:
